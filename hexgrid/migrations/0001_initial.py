...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hexgrid_nodeevent', (
            ...
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hexgrid.HGCharacter'])),
        ...
        db.create_table('hexgrid_charnode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hexgrid.HGCharacter'])),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hexgrid.Node'])),
            ('unlocked_on', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table('hexgrid_charnodewatch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('char', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hexgrid.HGCharacter'])),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hexgrid.Node'])),
        ...
        db.send_create_signal('hexgrid', ['HGCharacter'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'HGCharacter'
        db.delete_table('hexgrid_hgcharacter')
    ...
    models = {
        ...
        'hexgrid.charnodewatch': {
            ...
            'char': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hexgrid.HGCharacter']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hexgrid.Node']"}),
        ...
        'hexgrid.nodeevent': {
            ...
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hexgrid.HGCharacter']"}),
