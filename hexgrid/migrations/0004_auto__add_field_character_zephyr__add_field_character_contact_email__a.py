...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.zephyr'
        db.add_column('hexgrid_character', 'zephyr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True),
                      keep_default=False)

        # Adding field 'Character.contact_email'
        db.add_column('hexgrid_character', 'contact_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Character.contact_zephyr'
        db.add_column('hexgrid_character', 'contact_zephyr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.zephyr'
        db.delete_column('hexgrid_character', 'zephyr')

        # Deleting field 'Character.contact_email'
        db.delete_column('hexgrid_character', 'contact_email')

        # Deleting field 'Character.contact_zephyr'
        db.delete_column('hexgrid_character', 'contact_zephyr')
    ...
    models = {
        ...
        'hexgrid.character': {
            ...
            'contact_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'contact_zephyr': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'zephyr': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '8', 'blank': 'True'})
        },
        'hexgrid.charnode': {
