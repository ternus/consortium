...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsortiumApp.disc_guns'
        db.add_column('app_consortiumapp', 'disc_guns',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'ConsortiumApp.device'
        db.add_column('app_consortiumapp', 'device',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ConsortiumApp.zephyr'
        db.add_column('app_consortiumapp', 'zephyr',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsortiumApp.disc_guns'
        db.delete_column('app_consortiumapp', 'disc_guns')

        # Deleting field 'ConsortiumApp.device'
        db.delete_column('app_consortiumapp', 'device')

        # Deleting field 'ConsortiumApp.zephyr'
        db.delete_column('app_consortiumapp', 'zephyr')
    ...
    models = {
        'app.consortiumapp': {
            ...
            'disc_guns': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
