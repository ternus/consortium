...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.issuer'
        db.add_column('territory_action', 'issuer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['hexgrid.Character'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.issuer'
        db.delete_column('territory_action', 'issuer_id')
    ...
    models = {
        ...
        'territory.action': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issuer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['hexgrid.Character']", 'null': 'True'}),
